    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t4PostTestNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String t42Questions = question.getPostTestQuestion(randomIndex);
                String t42Btn1 = question.getPostTestChoice1(randomIndex);
                String t42Btn2 = question.getPostTestChoice2(randomIndex);
                String t42Btn3 = question.getPostTestChoice3(randomIndex);
                String t42Btn4 = question.getPostTestChoice4(randomIndex);
                String t42Solutions = question.getPreTestSolution(randomIndex);
                String t42Answers = question.getPreTestSolAnswer(randomIndex);
