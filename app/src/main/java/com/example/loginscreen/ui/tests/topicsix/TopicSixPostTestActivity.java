    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t6PostTestNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String t62Questions = question.getPostTestQuestion(randomIndex);
                String t62Btn1 = question.getPostTestChoice1(randomIndex);
                String t62Btn2 = question.getPostTestChoice2(randomIndex);
                String t62Btn3 = question.getPostTestChoice3(randomIndex);
                String t62Btn4 = question.getPostTestChoice4(randomIndex);
                String t62Solutions = question.getPreTestSolution(randomIndex);
                String t62Answers = question.getPreTestSolAnswer(randomIndex);
                ...
                dbHandler.storeT62Result(new TestResultModelClass(t62Questions, t62Btn1, t62Btn2, t62Btn3, t62Btn4, t62Solutions, t62Answers,
        ...
        t6PostTestResult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < questionLength; i++) {
                    TestResultModelClass testResult = dbHandler.getT62Result(i+1);
